...
for(let lang in this.langRegister){if(!this.langRegister[lang]){this.langRegister[lang]=this.shadowRoot.querySelector("#lang-"+lang)}let a=this.langRegister[lang];a.setAttribute("href",this.getLangUrl(lang))}}}window.customElements.define(NetspeakFooter.is,NetspeakFooter)});