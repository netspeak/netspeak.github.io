...
if(navigator.onLine){message=this.localMessage("netspeak-unreachable-error",`The Netspeak server failed to respond. Please retry in a few minutes.`)}else{message=this.localMessage("no-connection-error",`No response form the Netspeak server. Please make sure you have a stable internet connection.`)}}else{// everything that isn't a networking error or an error from Netspeak itself
