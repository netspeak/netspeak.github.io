...
if(0===element.childElementCount){element.textContent=text}}}}}).catch(e=>{/* ignore all errors. */});this.styleCode()}/**
	 ...
	 */styleCode(){if(!window.Prism)return;this.shadowRoot.querySelectorAll("code[class*=\"language-\"]:not([highlighted])").forEach(e=>{window.Prism.highlightElement(e);e.setAttribute("highlighted","")})}}_exports.NetspeakElement=NetspeakElement;const html=_polymerElement.html;/**
