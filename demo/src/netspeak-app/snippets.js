define(["exports", "./lru-cache.js"], function (_exports, _lruCache) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.Snippets = void 0;
  ...
  class Snippets {
    ...
    search(request) {
      try {
        if (!request) throw new Error("request cannot be " + request); // copy request and add defaults
