define(["exports", "meta", "../netspeak-app/netspeak-element.js"], function (_exports, meta, _netspeakElement) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.NetspeakExampleQueries = void 0;
  ...
  class NetspeakExampleQueries extends _netspeakElement.NetspeakElement {
    static get importMeta() {
      return meta;
    }

    static get is() {
      return 'netspeak-example-queries';
    }

    static get noDefaultLocalization() {
      return true;
    }
    ...
    constructor() {
      ...
      (0, _netspeakElement.loadLocalization)(NetspeakExampleQueries).then(json => {
        if (json) {
  ...
  _exports.NetspeakExampleQueries = NetspeakExampleQueries;
  (0, _netspeakElement.registerElement)(NetspeakExampleQueries);
});