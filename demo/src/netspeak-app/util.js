 ...
 * @returns {(...args: T) => void}
 * @template T
 */function debounce(func,wait,immediate){let timeout=void 0;return(/** @type {any} */function(){const fnArgs=/** @type {any} */arguments,fnThis=this;// @ts-ignore
clearTimeout(timeout);timeout=setTimeout(()=>{timeout=void 0;if(!immediate)func.apply(fnThis,fnArgs)},wait);if(immediate&&timeout===void 0)func.apply(fnThis,fnArgs)})}/**
 ...
 */function createClipboardButton(selector,text){// @ts-ignore
if("undefined"===typeof ClipboardJS){// load the library
...
if("undefined"===typeof ClipboardJS){throw new Error("Unable to load ClipboardJS")}}).then(()=>{return createClipboardButton(selector,text)})}// @ts-ignore
return Promise.resolve(new ClipboardJS(selector,{text(e){if("function"===typeof text){return text(e)}else{return text}}}))}/**
 *
 * @param {string} str
 * @returns {string}
