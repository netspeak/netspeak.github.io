define(["exports"], function (_exports) {
  ...
  function jsonp(url, timeout = 20000) {
    return new Promise((resolve, reject) => {
      try {
        if (!url) throw new Error("url cannot be " + url); // DO NOT use URL here
        ...
        url += prefix + 'callback=' + encodeURIComponent(addCallback(id, callbackSuccess)); // set timeout
