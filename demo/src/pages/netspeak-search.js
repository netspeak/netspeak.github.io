define(["exports", "meta", "../netspeak-app/netspeak-element.js", "../netspeak-app/netspeak-search-bar.js", "../netspeak-app/netspeak-corpus-selector.js"], function (_exports, meta, _netspeakElement, _netspeakSearchBar, _netspeakCorpusSelector) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.NetspeakSearch = void 0;
  meta = babelHelpers.interopRequireWildcard(meta);

  class NetspeakSearch extends _netspeakElement.NetspeakElement {
    static get importMeta() {
      return meta;
    }

    static get is() {
      return 'netspeak-search';
    }
    ...
    connectedCallback() {
      ...
      this.searchBar =
      /** @type {any} */
      this.shadowRoot.querySelector("netspeak-search-bar");
      /** @type {import("../netspeak-app/netspeak-corpus-selector").NetspeakCorpusSelector} */

      this.corpusSelector =
      /** @type {any} */
      this.shadowRoot.querySelector("netspeak-corpus-selector");
  ...
  _exports.NetspeakSearch = NetspeakSearch;
  (0, _netspeakElement.registerElement)(NetspeakSearch);
});