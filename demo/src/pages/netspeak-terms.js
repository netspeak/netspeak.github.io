define(["exports", "meta", "../netspeak-app/netspeak-element.js", "./page-styles.js", "../netspeak-app/netspeak-navigator.js"], function (_exports, meta, _netspeakElement, _pageStyles, _netspeakNavigator) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.NetspeakTerms = void 0;
  meta = babelHelpers.interopRequireWildcard(meta);

  class NetspeakTerms extends _netspeakElement.NetspeakElement {
    static get importMeta() {
      return meta;
    }

    static get is() {
      return 'netspeak-terms';
    }
...
<div class="article">
  ...
  _exports.NetspeakTerms = NetspeakTerms;
  (0, _netspeakElement.registerElement)(NetspeakTerms);
});