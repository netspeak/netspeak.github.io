define(["exports", "meta", "../netspeak-app/netspeak-element.js", "./page-styles.js", "../netspeak-app/netspeak-search-bar.js"], function (_exports, meta, _netspeakElement, _pageStyles, _netspeakSearchBar) {
  "use strict";

  Object.defineProperty(_exports, "__esModule", {
    value: true
  });
  _exports.NetspeakExamples = void 0;
  meta = babelHelpers.interopRequireWildcard(meta);

  class NetspeakExamples extends _netspeakElement.NetspeakElement {
    static get importMeta() {
      return meta;
    }

    static get is() {
      return 'netspeak-examples';
    }
...
`;
  ...
  _exports.NetspeakExamples = NetspeakExamples;
  (0, _netspeakElement.registerElement)(NetspeakExamples);
});