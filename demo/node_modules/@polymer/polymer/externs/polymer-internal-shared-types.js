 ...
 * }}
 */let LiteralBindingPart,MethodArg,MethodSignature,ExpressionBindingPart,BindingPart,Binding,PathInfo,TemplatizeOptions;/**
 * @typedef {{
 * literal: boolean,
 * name: string,
 * value: (string | number),
