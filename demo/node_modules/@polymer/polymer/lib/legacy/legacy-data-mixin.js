define(["exports", "./class.js", "../../polymer-legacy.js", "../utils/mixin.js", "../utils/templatize.js"], function (_exports, _class, _polymerLegacy, _mixin, _templatize) {
  ...
  */
  ...
  _polymerLegacy.Polymer.Class = (info, mixin) => (0, _class.Class)(info, superClass => mixin ? mixin(LegacyDataMixin(superClass)) : LegacyDataMixin(superClass)); // Apply LegacyDataMixin to Templatizer instances as well, and defer
